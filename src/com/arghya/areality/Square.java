...
public class Square {
     ...
     */
    public Square(float z, float scale, float alpha) {
        ...
        int vertexShader = MyGL20Renderer.loadShader(
        ...
        mProgram = GLES20.glCreateProgram();             // create empty OpenGL Program             // create empty OpenGL ES Program
